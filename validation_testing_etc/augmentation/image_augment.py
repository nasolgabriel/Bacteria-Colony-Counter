...
#                 grayscale_rotated_image = convert_to_grayscale(rotated_image)
#                 grayscale_rotated_image_path = os.path.join(augmented_images_dir, f"{filename.split('.')[0]}_rot{angle}_gray.jpg")
#                 grayscale_rotated_annotation_path = grayscale_rotated_image_path.replace(augmented_images_dir, augmented_labels_dir).replace('.jpg', '.txt')
#                 save_image_and_annotation(grayscale_rotated_image, rotated_annotations, grayscale_rotated_image_path, grayscale_rotated_annotation_path)
...
#                 # Save grayscale version
#                 grayscale_flipped_image = convert_to_grayscale(flipped_image)
#                 grayscale_flipped_image_path = os.path.join(augmented_images_dir, f"{filename.split('.')[0]}_{flip_name}_gray.jpg")
#                 grayscale_flipped_annotation_path = grayscale_flipped_image_path.replace(augmented_images_dir, augmented_labels_dir).replace('.jpg', '.txt')
#                 save_image_and_annotation(grayscale_flipped_image, flipped_annotations, grayscale_flipped_image_path, grayscale_flipped_annotation_path)
